...
void pointers_example_1()
{
	...
	ptr_a = &a;         // & se numeste referentiere si * dereferentiere  ( cu & aflam adresa unei variabile iar cu * aflam valoarea in functie de adresa)
	int tst = *ptr_a;
	...
	//  ...
	ptr_global_var = &(::var);       // :: - operator de scop
...
//	cout << "c: " << "Valoarea: " << ptr_c << "  -  la adresa: " << (void)ptr_c << endl;  // De ce (void*)?  Discutie       void* l am folosit ca sa facem cast la alt tip de caracter
