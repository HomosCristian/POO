...
void pointers_example_3()
{
	...
	*(ptr_array_var + 2) = 125;
	...
	delete ptr_array_var;           //elibereaza zona de memorie
}
...
void pointers_example_4()
{
	...
	char_array = (char*)"Acesta este test";      // facem cast (nu se mai pune /0 pt ca am scris un sir constant si se pune automat

	cout << char_array;
	cout << endl;

	//char_array[16] = '\0';                //eroare pt ca sirul de la linia 229 este un const si nu poate fi modificat
