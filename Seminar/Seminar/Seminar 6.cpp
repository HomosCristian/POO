...
public:
		...
		nume(_nume), varsta(_varsta), an_studii(_an_studii), numar_matricol(_numar_matricol), finantare(_finantare), numar_materii(_numar_materii)
	{
		...
		this->adresa = new char[strlen(_adresa) + 1];        //deep copy pt adresa
	...
	/*Student(const Student& student):
		Student(student.nume, student.adresa, student.varsta, student.an_studii, student.note, student.numar_materii, student.numar_matricol, student.finantare)   //acelasi lucru ca student e mai jos
	{
   ...
   //              - dezalocarea memoriei sa se realizeze fara a genera exceptii
	...
	Student(const Student& student)
	{
		...
		//this->adresa = student->adresa //asta e shallow copy si nu merge
		this->adresa = new char[strlen(student.adresa) + 1];        //deep copy pt adresa
